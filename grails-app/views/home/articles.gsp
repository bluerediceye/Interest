...
<div id="mainpage" class="normalpage">
    <div id="left" class="widepage">
        <div class="post">
            ...
            <p><r:img class="alignleft" uri="/images/image4.jpg" alt="Image"
                    width="270"
            ...
            <div class="postbottom"><a href="#">Permalink</a> <a href="#">Comments</a> <a
                    href="#">Category</a> <a href="#">Author</a></div>
        </div>
        ...
        <div class="post">
            ...
            <blockquote
                    class="alignleft"><p>Vivamus scelerisque sagittis lorem. Nunc tincidunt eleifend  risus.</p>
            </blockquote>
        ...
        <div class="post">
            ...
            <form action="#">
                <div class="formstyle">
                    ...
                    <label for="email">email:</label><input class="text_field" id="email" name="email"
                                                            type="text"/>
