...
<div id="mainpage" class="normalpage">
    <div id="left" class="widepage">
        <div class="post">
            <h2><a href="#">License &amp; Permission</a></h2>

            <div class="postmeta"><span class="date">Posted on 12 June 2010</span> <span
                    class="author">By YourName</span><span class="category">Example Category</span></div>
            <a rel="license" href="http://sc.chinaz.com/"><img alt="Creative Commons License" style="border-width:0"
                                                               src="http://i.creativecommons.org/l/by-sa/3.0/us/88x31.png"/>
            </a><br/><span xmlns:dc="http://purl.org/dc/elements/1.1/"
                           href="http://purl.org/dc/dcmitype/InteractiveResource" property="dc:title"
                           rel="dc:type">CSSH-1 Free CSS Template</span> by <a
                xmlns:cc="http://creativecommons.org/ns#" href="http://www.cssheaven.org"
                property="cc:attributionName" rel="cc:attributionURL">Roshan M. Ravi</a> is licensed under a <a
                rel="license"
                href="http://sc.chinaz.com/">Creative Commons Attribution-Share Alike 3.0 United States License</a>.<br/>Based on a work at <a
                xmlns:dc="http://purl.org/dc/elements/1.1/" href="http://www.cssheaven.org"
                rel="dc:source">www.cssheaven.org</a>.<br/>Permissions beyond the scope of this license may be available at <a
                xmlns:cc="http://creativecommons.org/ns#" href="http://www.cssheaven.org"
                rel="cc:morePermissions">http://www.cssheaven.org</a>.  <p>Example of image in a post without a css class</p>
            <r:img uri="/images/image6.jpg" alt="chat"/>
        ...
        <div class="post">
            ...
            <blockquote class="alignleft"><p>Vivamus scelerisque sagittis lorem. Nunc tincidunt eleifend  risus.</p>
            </blockquote>
        ...
        <div class="post">
            ...
            <form action="#">
                <div class="formstyle">
                    ...
                    <label for="email">email:</label><input class="text_field" id="email" name="email" type="text"/>
            ...
            <p></p><span class="readmore"><a href="#">Read More</a></span>
